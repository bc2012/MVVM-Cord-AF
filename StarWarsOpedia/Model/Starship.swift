...
// This extension allows DetailViewController to get the correct labels and values for a Starship from the model itself.
//
extension Starship: DisplayableProtocol {
